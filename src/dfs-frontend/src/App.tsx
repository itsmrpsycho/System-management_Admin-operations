...
import ModelSelector from "./containers/dataModels/modelSelect";
import FileSelector from "./containers/datasetadd/chooseJsonFile";
import { View } from "./components/styled/View";
import AutoAddDataset from "./containers/datasetadd/autoAddDataset";
      ...
      <div className="App">
        ...
        <ToastContext.Provider value={{addToast}}>
          <Routes>
            ...
            <Route path="/file-selector" element={<FileSelector />} />
            ...
            <Route path="/fileupload/:dataset_id/:dataset_name" element={<AutoFileupload />} />
            <Route path="/verify" element={<Verify />} />
            <Route path="/add-dataset" element={<AddDataset />} />
            <Route path="/add-dataset/:data" element={<AddDataset />} />
            <Route path="/auto-add-dataset" element={<AutoAddDataset />} />
            <Route path="/add-dataModel" element={<AddDataModel />} />
            <Route path="/add-dataModel/:data" element={<AddDataModel />} />
