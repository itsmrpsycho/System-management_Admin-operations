...
const Autouploadfiles = ({
  ...
  const[filepaths,setfilepaths] = useState(["C:\Users\Vinkesh Bansal\Downloads\Assignment 3 (1)"])
...
useEffect(() => {
  if (dummyData) {
    setFileType(dummyData.filetype || "");
    setDatabaseVersionId(dummyData.databaseVersionId || "")
    setVersionName(dummyData.version_name || "")
    setReference(dummyData.reference|| "")
    setCreatedDate(dummyData.created_date|| "")
    setFilesize(dummyData.filesize|| "")

    // setUpfilename(dummyData.upfilename|| "")
    // setUpfilenameMD(dummyData.upfilenameMD|| "")

    setPublNames(dummyData.publication_names|| "")
    setPublLinks(dummyData.publication_links|| "")
  }
}, [dummyData]);

// useEffect(() => {
//   console.log('vineksdhl')
...
export default Autouploadfiles;
